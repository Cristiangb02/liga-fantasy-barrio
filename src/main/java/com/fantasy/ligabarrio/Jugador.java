...
import java.time.LocalDateTime; // IMPORTANTE: Necesario para el blindaje por horas
...
public class Jugador {
    ...
    public void setFechaFinBlindaje(LocalDateTime fechaFinBlindaje) {
        this.fechaFinBlindaje = fechaFinBlindaje;
    }
}